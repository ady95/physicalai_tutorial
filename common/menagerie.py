...
전체를 받으면 2 GB가 넘기 때문에, 이 책에서 쓰는 로봇 폴더만 sparse checkout 으로 받습니다
(처음 한 번, 수십 MB). 저장 위치는 저장소 루트의 third_party/mujoco_menagerie 입니다.
이미 전체 사본이 있으면 환경변수 MENAGERIE_DIR 로 그 경로를 지정하세요.
"""
