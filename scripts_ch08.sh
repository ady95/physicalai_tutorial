...
TOPCAM=${TOPCAM:-top}          # 데이터셋에 쓴 위 카메라 (top 또는 top_zoom)

# 8-3 (빠름, 6부 ACT 만 필요)
run ch08_robustness    python ch08/robustness.py --checkpoint $ACT --episodes 10 --top-camera $TOPCAM
...
run ch08_gen_fixed_A   python ch06/eval_act.py --checkpoint $ACTF --episodes 10 --cube 0.24 0.0 --top-camera $TOPCAM
run ch08_gen_fixed_B   python ch06/eval_act.py --checkpoint $ACTF --episodes 10 --cube 0.22 0.08 --top-camera $TOPCAM
run ch08_gen_fixed_C   python ch06/eval_act.py --checkpoint $ACTF --episodes 10 --cube 0.20 -0.10 --top-camera $TOPCAM
run ch08_gen_fixed_R   python ch06/eval_act.py --checkpoint $ACTF --episodes 20 --top-camera $TOPCAM
run ch08_gen_rand_A    python ch06/eval_act.py --checkpoint $ACT --episodes 10 --cube 0.24 0.0 --top-camera $TOPCAM
run ch08_gen_rand_B    python ch06/eval_act.py --checkpoint $ACT --episodes 10 --cube 0.22 0.08 --top-camera $TOPCAM
run ch08_gen_rand_C    python ch06/eval_act.py --checkpoint $ACT --episodes 10 --cube 0.20 -0.10 --top-camera $TOPCAM
