#!/usr/bin/env bash
# 9부 실측 파이프라인 — LLM Planner
#   9-3: 3-6과 같은 블록 위치 10곳에서 Pick and Place. perception 세 가지 비교
#   9-5: 8-1과 같은 배치·문장·판정으로 색 지정 과제. SmolVLA 와 비교
#
...
echo "모델 $OPENAI_MODEL  / 9-3 각 $TRIALS 회, 9-5 배치 $LAYOUTS 개"
